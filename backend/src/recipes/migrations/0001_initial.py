# Generated by Django 3.2.16 on 2025-06-18 07:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "measurement_unit",
                    models.CharField(
                        blank=True, max_length=64, verbose_name="Единица измерения"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("user", django.db.models.expressions.F("subscribed")),
                    _negated=True,
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("user", "recipe"), name="unique_in_shoppingcart"
            ),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name="favorite",
            constraint=models.UniqueConstraint(
                fields=("user", "recipe"), name="unique_in_favorite"
            ),
        ),
    ]
