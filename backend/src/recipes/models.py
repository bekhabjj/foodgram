...
class User(AbstractUser):
    ...
    email = models.CharField(
        verbose_name="Адрес электронной почты", max_length=LONG_MAX_LENGTH, unique=True
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.UniqueConstraint(
                fields=["user", "subscribed"], name="unique_subscription"
            ),
            # Запрещена подписка на себя.
            models.CheckConstraint(
                check=~models.Q(user=models.F("subscribed")), name="self_subscription"
            ),
        ]
...
class Tag(models.Model):
    ...
    name = models.CharField(
        verbose_name="Название", max_length=TAG_MAX_LENGTH, unique=True
    )
...
class Ingredient(models.Model):
    ...
    measurement_unit = models.CharField(
        max_length=SHORT_MAX_LENGTH, verbose_name="Единица измерения", blank=True
    )
    ...
    class Meta:
        ...
        ordering = ("name",)
        constraints = [
            # продукт записан один раз.
            models.UniqueConstraint(
                fields=["name", "measurement_unit"], name="unique_in_ingredients"
            )
        ]
...
class Recipe(models.Model):
    ...
    name = models.CharField(max_length=LONG_MAX_LENGTH, verbose_name="Название")
    ...
    cooking_time = models.SmallIntegerField(
        verbose_name="Время (мин)", validators=[MinValueValidator(MIN_COOKING_MINUTES)]
    )
...
class IngredientInRecipe(models.Model):
    ...
    amount = models.IntegerField(
        verbose_name="Мера", validators=[MinValueValidator(MIN_INGREDIENT_AMOUNT)]
    )
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.UniqueConstraint(
                fields=["recipe", "ingredient"], name="unique_in_recipe"
            )
        ]
...
class Mark(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.UniqueConstraint(
                fields=["user", "recipe"], name="unique_in_%(class)s"
            )
        ]
